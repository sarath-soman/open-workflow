...
async function runCommand(argv: string[]) {
  ...
  const workflowPath = await resolveWorkflowTarget(target, cwd, stringFlag(flags.config))
...
async function resolveWorkflowTarget(target: string, cwd: string, configPath?: string) {
